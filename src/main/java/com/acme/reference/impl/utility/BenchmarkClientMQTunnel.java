...
public class BenchmarkClientMQTunnel {
	...
	private BenchmarkClientMQTunnel(String queue, String host) {
		rabbitMQChannel = BenchmarkClientMQChannelFactory.open(queue, host);
		this.queue = queue;
	}

	public static BenchmarkClientMQTunnel newInstance(String queue, String host) {
		return new BenchmarkClientMQTunnel(queue, host);
	}
